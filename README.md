...
Tampermonkey-скрипт для сайта **Preax**, который добавляет кнопку копирования в интерфейс код-ревью и позволяет быстро скопировать отзыв **в формате Markdown** — целиком или по отдельным изображениям.
